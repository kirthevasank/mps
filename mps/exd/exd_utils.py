...
# Loading options and reporter ----------------------------------------------------------
def load_options_and_reporter(option_specs, options, reporter):
  """ Loads options and reporter. """
  reporter = get_reporter(reporter)
  if options is None and option_specs is not None:
    options = load_options(option_specs, reporter)
