...
class DirectTestCase(BaseTestClass):
  ...
  def test_random_maximise(self):
    ...
    for prob in self.problems:
      max_val_soln, _, _ = oper_utils.random_maximise(
        prob.obj, prob.bounds, 2 * self.max_evals, vectorised=False)
  ...
  def test_direct(self):
    ...
    for prob in self.problems:
      ...
      min_val_soln, _, _ = oper_utils.direct_ft_minimise(
        prob.obj, prob.bounds, self.max_evals)
  ...
  def test_direct_times(self):
    ...
    for prob in self.problems:
      ...
      for log_file_name in log_file_names:
        ...
        _, _, _ = oper_utils.direct_ft_minimise(
          prob.obj, prob.bounds, self.max_evals, log_file_name=log_file_name)
